...
ControllerServer::on_configure(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  pause_controller_sub_ = create_subscription<std_msgs::msg::Bool>(
    "/pause_controller", rclcpp::QoS(10),
    std::bind(&ControllerServer::pauseControllerCallback, this, std::placeholders::_1));
...
void ControllerServer::pauseControllerCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
  is_pause_controller_ = msg->data;
}
